...
<head>
  ...
  <meta name="description" content="An 84-question Python knowledge challenge based on the supplied study materials.">
  <title>PyQuest - 84 Question Challenge</title><link rel="stylesheet" href="assets/style.css">
</head>
<body>
  <div class="ambient ambient-one"></div><div class="ambient ambient-two"></div>
  <header class="topbar"><a class="brand" href="#" aria-label="PyQuest home"><span class="brand-mark">P</span><span>PyQuest</span></a><div class="top-actions"><span class="source-pill">84 Python questions</span><button class="icon-button" id="themeButton" type="button" aria-label="Toggle dark mode">☾</button><button class="icon-button" id="soundButton" type="button" aria-label="Toggle sound">♪</button></div></header>
  <main>
    <section class="screen welcome-screen active" id="welcomeScreen">
      <div class="hero-copy"><span class="eyebrow">INTRODUCTION TO PROGRAMMING USING PYTHON</span><h1>Ready to put your<br><span>Python knowledge</span> to the test?</h1><p>Work through all 84 questions from your study materials. Build answer sequences, get instant feedback, and track your best run.</p><label class="shuffle-option"><input id="shuffleToggle" type="checkbox"><span class="toggle-track"><i></i></span><span><strong>Shuffle mode</strong><small>Randomize questions and answer-button positions</small></span></label><label class="shuffle-option pause-option"><input id="pauseWrongToggle" type="checkbox" checked><span class="toggle-track"><i></i></span><span><strong>Pause after wrong answers</strong><small>Continue only when you are ready</small></span></label><div class="hero-actions"><button class="primary-button" id="startButton" type="button">Start all 84 <span>→</span></button><button class="secondary-button" id="newQuestionsButton" type="button">New Questions</button><button class="secondary-button" id="resumeButton" type="button" hidden>Resume run</button></div><div class="stats-strip"><div><strong>84</strong><span>Questions</span></div><div><strong id="bestScore">—</strong><span>Best score</span></div><div><strong>4</strong><span>Answer formats</span></div></div></div>
...
(3*(1+2)**2 - (2**2)*3)</pre><div class="mock-options"><span>A</span><span>B</span><span class="selected">C</span><span>D</span></div><div class="mock-progress"><i></i></div></div></div>
    ...
    <section class="screen quiz-screen" id="quizScreen">
      <div class="quiz-topline"><div><span class="mini-label">PYTHON CHALLENGE</span><strong id="questionCounter">Question 1 of 84</strong></div><div class="timer" id="timer">00:00</div></div><div class="progress-track"><span id="progressBar"></span></div>
